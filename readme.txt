...
== Requirements ==
WromoX Themes WooCommerce 1.1.70
...
Add - Rearranging css
Add - pictures integration menu
Add - icon menu
Add - logo plugin integration menu admin wordpress backend
Add - synchronization Template rendering images

30-11-2022 - Update version to 1.0.01
Add - CSS redraw admin backend plugin
Add - attach template button

21-07-2022 - Update version to 1.0.00
Add - plugins import theme WromoX
Add - theme installation sync
Add - icon menu
